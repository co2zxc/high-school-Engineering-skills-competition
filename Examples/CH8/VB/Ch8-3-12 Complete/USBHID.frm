...
'列表盒的底部Scroll to the bottom of the list box.
...
'針對每一個所要送出的位元組，開啟下列的選單盒dropdown list box
For Count = 0 To 255
