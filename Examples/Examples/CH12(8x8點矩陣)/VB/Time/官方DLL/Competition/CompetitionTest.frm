...
Private Sub Timer1_Timer()
    ...
    'For i = 0 To 32
        'left
        OutDataEightByte &H20, ((timeI + rl) \ 8) Mod 4, (timeI + rl) Mod 8, numberData(timeArray(timeI \ 4), (timeI Mod 4) + 1), 0, 0, 0, 0
        'right
        'OutDataEightByte &H20, ((timeI + rl) \ 8) Mod 4, (timeI + rl) Mod 8, numberData(timeArray(timeI \ 4), timeI Mod 4), 0, 0, 0, 0
    'Next i
    'right
    'rl = rl + 1
    'If (rl >= 32) Then
