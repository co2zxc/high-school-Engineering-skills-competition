    ...
    Select Case ReadKeyData(1)
        ...
        Case 1   'OFF
            If ba = 1 Then
                ba = 0
                For j = 2 To 5
                     OutDataEightByte &H20, 3, j, number(bi(3), j), 0, 0, 0, 0
                     OutDataEightByte &H20, 2, j, number(bi(2), j), 0, 0, 0, 0
                     OutDataEightByte &H20, 1, j, number(bi(1), j), 0, 0, 0, 0
                     OutDataEightByte &H20, 0, j, number(bi(0), j), 0, 0, 0, 0
                 Next j
                 bi(3) = bi(3) + 1
                 bi(2) = bi(2) + (bi(3) \ 10)
                 bi(1) = bi(1) + (bi(2) \ 10)
