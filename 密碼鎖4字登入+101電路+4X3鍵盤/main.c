...
static uchar picture1[16]={0x11,0x11,0x0A,0x04,0x1F,0x1F,0x1F,0x00,0x11,0x15,0x15,0x11,0x04,0x0e,0x1f};
static uchar VB_ON_OFF; //0 : off  1 : on   2 : end
static uchar page,scan_in,count1,station_number,Countdown,Gb,TR,xx,qq;
...
uchar   usbFunctionWrite(uchar *data, uchar len)
{
    ...
    switch(*(data+1))
	{
		...
		case 0x0b:
			...
			DISP_Chr(0x8f,0x01);
			DISP_Str(0xc0,"  ");
			DISP_Chr(0xc2, 0x30 |  *(data+2));  
			DISP_Chr(0xc3, 0x30 |  *(data+3)); 
			DISP_Str(0xc4," - ");
			DISP_Chr(0xc7, 0x30 |  *(data+4));  
			DISP_Chr(0xc8, 0x30 |  *(data+5));
			DISP_Str(0xc9," - ");
			DISP_Chr(0xcC, 0x30 |  *(data+6));  
			DISP_Chr(0xcD, 0x30 |  *(data+7));  
			DISP_Str(0xcE,"  ");
		break;
		case 0x0c:
			LCD_remove();
