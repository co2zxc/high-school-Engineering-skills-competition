...
Public Const VendorID = &H1234				' USB HID裝置販售商碼
Public Const ProductID = &H2468				' USB HID裝置販產品碼

Public Sub OutData(ByVal Data1 As Byte, ByVal Data2 As Byte)
    OutDataEightByte &H20, Data1, Data2, 0, 0, 0, 0, 0
End Sub
