...
static uchar d0,d1,d2,d3,d4,porta,portb,portc;
...
//	PORTD = 0x00;   //    0      0      0      0      0      0      0      0  
	...
	{                /* main event loop */
		...
		outputPORTA(0x00);		//遮沒信號
		outputPORTB(0xf7);		//掃描線  1111 0111
		outputPORTA(~seg[d0]);
		_delay_ms(4);
	
		outputPORTA(0x00);		//遮沒信號
		outputPORTB(0xfb);		//掃描線  1111 1011
		if (d4==1)
		{
		  outputPORTA((~seg[d1])|0x80);		//pgfe dcba = 1000 0000
		}
		else
		{
		  outputPORTA(~seg[d1]);
		...
		outputPORTA(0x00);		//遮沒信號
		outputPORTB(0xfd);		//掃描線  1111 1101
		outputPORTA(~seg[d2]);
		_delay_ms(4);	
		
		outputPORTA(0x00);		//遮沒信號
		outputPORTB(0xfe);		//掃描線  1111 1110
		outputPORTA(~seg[d3]);
		_delay_ms(4);	
