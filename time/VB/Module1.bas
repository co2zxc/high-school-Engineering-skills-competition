...
Public Declare Sub OutDataEightByte Lib "USBHIO.dll" (ByVal OutData1 As Byte, ByVal OutData2 As Byte, ByVal OutData3 As Byte, ByVal OutData4 As Byte, ByVal OutData5 As Byte, ByVal OutData6 As Byte, ByVal OutData7 As Byte, ByVal OutData8 As Byte)
